                ...
                <div class="tab-content">
                  ...
                  <form class="form-horizontal" action="update_profile.php?user_id=<?php echo $entry->getId(); ?>" method="POST">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <select class="form-control select2" name="Gender" id="inputGender" required>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="Address" id="inputFirstname" placeholder="Address" value="<?php echo $entry->getAddress(); ?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputFirstname" class="col-sm-2 col-form-label">City</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="City" id="inputFirstname" placeholder="City" value="<?php echo $entry->getCity(); ?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputFirstname" class="col-sm-2 col-form-label">Province</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="Province" id="inputFirstname" placeholder="Province" value="<?php echo $entry->getProvince(); ?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputFirstname" class="col-sm-2 col-form-label">Mobile No.</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="Phone" id="inputFirstname" placeholder="Mobile No." value="<?php echo $entry->getPhone(); ?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" id="inputStdntNo" placeholder="Student No." name="StdNo" value="<?php echo $entry->getStNo(); ?>" disabled required>
                      </div>
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text">@</span>
